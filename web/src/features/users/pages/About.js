    ...
    <div className="about-background min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-8">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-6xl font-light text-white mb-6 tracking-wide" style={{ fontFamily: 'Georgia, serif' }}>
            Welcome to Voxa
          </h1>
          <p className="text-2xl text-white/95 mb-12 font-normal leading-relaxed" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
            Your centralized dashboard for viewing and accessing available surveys and announcements
          </p>
