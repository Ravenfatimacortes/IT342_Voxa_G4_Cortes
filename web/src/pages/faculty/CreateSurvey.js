                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="mt-1 block w-full pl-3 pr-10 py-2 text-base bg-gray-700/50 border-gray-600 text-white focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm rounded-md"
                        >
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          ...
                          type="checkbox"
                          className="h-5 w-5 text-blue-600 focus:ring-blue-500 focus:ring-2 focus:ring-offset-2 border-gray-500 rounded-md bg-gray-700/50 cursor-pointer transition-all duration-200 hover:border-blue-400"
                        />
