...
async function checkSurvey32Responses() {
  try {
    console.log('=== Checking Survey 32 Responses ===');
    
    // Get responses for survey 32
    ...
    console.log('✅ Retrieved responses for survey 32');
