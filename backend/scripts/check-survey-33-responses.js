...
async function checkSurvey33Responses() {
  try {
    console.log('=== Checking Survey 33 Responses ===');
    
    // Get responses for survey 33
    ...
    console.log('✅ Retrieved responses for survey 33');
